...
class Profile(DBManager):
    ...
    def get_user_interests(self, user_id):
        ...
        where_clause = f"tag_id IN ({placeholders})"
        
        name_results = self.select('tags', "tag_name", where=where_clause, where_params=tuple(tag_ids))
    ...
    def get_images(self, user_id):
        ...
        return [{'image_id': image['image_id'], 'image_url': image['image_url']} for image in result]
